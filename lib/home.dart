...
//RED HAT OPENSHIFT IMGE FILE => codait/max-image-caption-generator
...
class _HomeState extends State<Home> {
  ...
  Future<Map<String, dynamic>> fetchResponse(File image) async {
    ...
    final imageUploadRequest = http.MultipartRequest(
        'POST',
        Uri.parse(
            'http://max-image-caption-generator-test.2886795305-80-kota05.environments.katacoda.com/model/predict'));
